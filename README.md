...
- Le dossier **Continious containeization** : contient le code Terraform (IaC) création de ressource sur Azure
...
La phase d'initailisation permet **Configurer Terraform** & de construire les **environnements TEST et PROD** et d'y déployer un première de l'application
